    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            if((a >= 2000 ) && (localdate.getYear()>=1)){
                ...
                Cliente cliente=new ClienteA(1,"Eugenia","Cabrera","11222456","c@mi.com",localdate,cuentas1,a,prestamos1);
            ...
            if(a<2000 & a != 0 &  (localdate.getYear()<=1)){
                ...
                Cuenta[] cuentas1 = {cuenta1, cuenta2};
                Cliente cliente=new ClienteB(2,"Juan","Perez","11222456","c@mi.com",localdate,cuentas1,a,prestamos1);
                clientes.add(cliente);
            ...
            if(a==0f){
                ...
                Cliente cliente3=new Estudiante(10, "Eugenia", "Gonzales", "1212121", "c@@@", localdate, cuenta3);
